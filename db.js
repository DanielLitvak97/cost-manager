(function () {
    ...
    // Validates exchange-rate data received from a server.
    ...
    function createReport(currency, year, month) {
        ...
        // The report currency must be supported.
    ...
    db.openCostsDB = function (
        ...
        // Update the stored version when necessary.
         ...
         */
        databaseObject.getReport = function (
            currency,
            year,
            month
        ) {
        ...
        /*
         * Returns all stored costs.
         *
         * This additional function is used by the application charts.
         */
        databaseObject.getAllCosts = function () {
            if (currentDatabase === null) {
                throw new Error(
                    "No database is currently open."
                );
     ...
     * Returns a detailed report synchronously.
     *
     * This function is kept for compatibility with the older
     * sample API, although the required API is ob.getReport().
     */
    ...
    /*
     * Replaces the in-memory exchange rates.
     *
     * This is used by the production application when
     * currency.js retrieves rates from the configured URL.
     */
     ...
     * the user has not configured a custom exchange-rate URL.
     *
     * In the production application, currency.js handles
     * the custom URL and updates the cached rates.
     */
    if (
        localStorage.getItem(
