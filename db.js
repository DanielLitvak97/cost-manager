(function () {
    ...
    function validateCost(cost) {
        ...
        if (cost.sum <= 0) {
            throw new Error("Cost sum must be greater than zero.");
        }

        // Prevent unrealistically large cost values.
        if (cost.sum > 1000000000) {
            throw new Error(
                "Cost sum cannot be greater than 1,000,000,000."
            );
        }
        ...
        if (!categoryPattern.test(cost.category.trim())) {
            throw new Error(
    ...
    // The complete application retrieves rates from a server.
    ...
    db.openCostsDB = function (databaseName, databaseVersion) {
        ...
        /*
         * Returns a detailed report through the opened database object.
         */
        ...
        /*
         * Returns all cost items currently stored in the database.
         *
         * This additional function is used by the charts.
         */
