(function () {
    ...
    /*
     * Start loading the default exchange rates asynchronously.
     *
     * getReport() remains synchronous and may throw an exception
     * if it is called before this asynchronous operation completes.
     */
